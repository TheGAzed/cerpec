...
size_t get_fstraight_list(fstraight_list_s const * const list, size_t const index, void * const buffer) {
    error(list && "Paremeter can't be NULL.");
...
fstraight_list_s extract_fstraight_list(fstraight_list_s * const list, filter_fn const filter, void * const af, size_t const list_max, size_t const extract_max) {
    ...
    fstraight_list_s positive = {
        ...
        .elements = list->allocator->alloc(extract_max * list->size, list->allocator->arg),
        .next = list->allocator->alloc(extract_max * sizeof(size_t), list->allocator->arg),
    };
...
void each_fstraight_list(fstraight_list_s const * const list, manage_fn const manage, void * const am) {
    error(list && "Paremeter can't be NULL.");

...
TEST CONTAINS_01(void) {
    ...
    for (size_t i = 0; i < IBITWISE_SET_CHUNK - 1; ++i) {
        ASSERT(contains_ibitwise_set(&set, i));
    }
...
TEST UNION_01(void) {
    ...
    for (size_t i = 0; i < IBITWISE_SET_CHUNK - 1; ++i) {
        ASSERT(contains_ibitwise_set(&set_union, i));
    }
...
TEST INTERSECT_01(void) {
    ...
    for (size_t i = 0; i < IBITWISE_SET_CHUNK - 1; ++i) {
        ASSERT(contains_ibitwise_set(&set_intersect, i));
    }
...
TEST INTERSECT_04(void) {
    ...
    for (size_t i = 0; i < IBITWISE_SET_CHUNK - 1; ++i) {
        ASSERT_FALSE(contains_ibitwise_set(&set_intersect, i));
    }
...
TEST SUBTRACT_01(void) {
    ...
    for (size_t i = 0; i < IBITWISE_SET_CHUNK - 1; ++i) {
        ASSERT_FALSE(contains_ibitwise_set(&set_subtract, i));
    }
...
TEST SUBTRACT_04(void) {
    ...
    for (size_t i = 0; i < (IBITWISE_SET_CHUNK - 1) / 2; ++i) {
        ASSERT(contains_ibitwise_set(&set_subtract, i));
    }
...
TEST EXCLUDE_01(void) {
    ...
    for (size_t i = 0; i < IBITWISE_SET_CHUNK - 1; ++i) {
        ASSERT_FALSE(contains_ibitwise_set(&set_exclude, i));
    }
...
TEST EXCLUDE_04(void) {
    ...
    for (size_t i = 0; i < IBITWISE_SET_CHUNK - 1; ++i) {
        ASSERT(contains_ibitwise_set(&set_exclude, i));
    }
...
TEST IS_SUBSET_01(void) {
    ...
    ASSERT(is_subset_ibitwise_set(&set_one, &set_two));
...
TEST IS_SUBSET_07(void) {
    ...
    ASSERT_FALSE(is_subset_ibitwise_set(&set_one, &set_two));
...
TEST IS_PROPER_SUBSET_01(void) {
    ...
    ASSERT(is_proper_subset_ibitwise_set(&set_one, &set_two));
...
TEST IS_PROPER_SUBSET_04(void) {
    ...
    ASSERT_FALSE(is_proper_subset_ibitwise_set(&set_one, &set_two));
...
TEST IS_DISJOINT_01(void) {
    ...
    ASSERT_FALSE(is_disjoint_ibitwise_set(&set_one, &set_two));
...
TEST IS_DISJOINT_04(void) {
    ...
    ASSERT(is_disjoint_ibitwise_set(&set_one, &set_two));

...
TEST COPY_01(void) {
    ...
    frb_set_s replica = copy_frb_set(&set, intcpy, NULL);
    ...
    destroy_frb_set(&set, intdst, NULL);
    destroy_frb_set(&replica, intdst, NULL);
...
TEST UNION_01(void) {
    ...
    frb_set_s set_union = union_frb_set(&set_one, &set_two, intcpy, NULL);

    for (int i = 0; i < FRB_SET_CHUNK - 1; ++i) {
        ASSERT(contains_frb_set(&set_union, &i));
    }

    destroy_frb_set(&set_one, intdst, NULL);
    destroy_frb_set(&set_two, intdst, NULL);
    destroy_frb_set(&set_union, intdst, NULL);
...
TEST INTERSECT_01(void) {
    ...
    frb_set_s set_intersect = intersect_frb_set(&set_one, &set_two, intcpy, NULL);
    ...
    destroy_frb_set(&set_one, intdst, NULL);
    destroy_frb_set(&set_two, intdst, NULL);
    destroy_frb_set(&set_intersect, intdst, NULL);
...
TEST SUBTRACT_01(void) {
    ...
    frb_set_s set_subtract = subtract_frb_set(&set_one, &set_two, intcpy, NULL);
    ...
    destroy_frb_set(&set_one, intdst, NULL);
    destroy_frb_set(&set_two, intdst, NULL);
    destroy_frb_set(&set_subtract, intdst, NULL);
...
TEST EXCLUDE_01(void) {
    ...
    frb_set_s set_exclude = exclude_frb_set(&set_one, &set_two, intcpy, NULL);
    ...
    destroy_frb_set(&set_one, intdst, NULL);
    destroy_frb_set(&set_two, intdst, NULL);
    destroy_frb_set(&set_exclude, intdst, NULL);

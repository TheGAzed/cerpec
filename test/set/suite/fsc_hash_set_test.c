...
TEST UNION_01(void) {
    ...
    fsc_hash_set_s set_union = union_fsc_hash_set(&set_one, &set_two, intcpy, NULL);
...
TEST INTERSECT_01(void) {
    ...
    fsc_hash_set_s set_intersect = intersect_fsc_hash_set(&set_one, &set_two, intcpy, NULL);
...
TEST SUBTRACT_01(void) {
    ...
    fsc_hash_set_s set_subtract = subtract_fsc_hash_set(&set_one, &set_two, intcpy, NULL);
...
TEST EXCLUDE_01(void) {
    ...
    fsc_hash_set_s set_exclude = exclude_fsc_hash_set(&set_one, &set_two, intcpy, NULL);

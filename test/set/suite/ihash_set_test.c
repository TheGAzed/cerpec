...
TEST CREATE_01(void) {
    ihash_set_s set = create_ihash_set(sizeof(int), inthshmurmur, intcmp);
...
TEST UNION_01(void) {
    ihash_set_s set_one = create_ihash_set(sizeof(int), inthshmurmur, intcmp);
    ihash_set_s set_two = create_ihash_set(sizeof(int), inthshmurmur, intcmp);
    ...
    ihash_set_s set_union = union_ihash_set(&set_one, &set_two, intcpy);

    for (int i = 0; i < IHASH_SET_CHUNK - 1; ++i) {
        ASSERT(contains_ihash_set(&set_union, &i));
    }

    destroy_ihash_set(&set_one, intdst);
    destroy_ihash_set(&set_two, intdst);
    destroy_ihash_set(&set_union, intdst);
...
TEST INTERSECT_01(void) {
    ...
    ihash_set_s set_intersect = intersect_ihash_set(&set_one, &set_two, intcpy);
    ...
    destroy_ihash_set(&set_one, intdst);
    destroy_ihash_set(&set_two, intdst);
    destroy_ihash_set(&set_intersect, intdst);
...
TEST SUBTRACT_01(void) {
    ...
    ihash_set_s set_subtract = subtract_ihash_set(&set_one, &set_two, intcpy);
    ...
    destroy_ihash_set(&set_one, intdst);
    destroy_ihash_set(&set_two, intdst);
    destroy_ihash_set(&set_subtract, intdst);
...
TEST EXCLUDE_01(void) {
    ...
    ihash_set_s set_exclude = exclude_ihash_set(&set_one, &set_two, intcpy);
    ...
    destroy_ihash_set(&set_one, intdst);
    destroy_ihash_set(&set_two, intdst);
    destroy_ihash_set(&set_exclude, intdst);

...
TEST CREATE_01(void) {
    ...
    destroy_istraight_list(&test, intdst, NULL);
...
TEST CLEAR_01(void) {
    ...
    clear_istraight_list(&test, intdst, NULL);
...
TEST COPY_01(void) {
    ...
    destroy_istraight_list(&test, intdst, NULL);
    destroy_istraight_list(&replica, intdst, NULL);
...
TEST REMOVE_FIRST_01(void) {
    ...
    for (int i = 0; i < ISTRAIGHT_LIST_CHUNK - 1; ++i) {
        int t = 0;
        remove_first_istraight_list(&test, &i, &t, intcmp, NULL);
        ASSERT_EQ(i, t);
    }
...
TEST SPLICE_01(void) {
    ...
    destroy_istraight_list(&one, intdst, NULL);
    destroy_istraight_list(&two, intdst, NULL);
...
TEST SPLIT_01(void) {
    ...
    destroy_istraight_list(&test, intdst, NULL);
    destroy_istraight_list(&split, intdst, NULL);
...
TEST EXTRACT_01(void) {
    ...
    istraight_list_s extract = extract_istraight_list(&test, intfilodd, NULL);
    ...
    destroy_istraight_list(&test, intdst, NULL);
    destroy_istraight_list(&extract, intdst, NULL);
...
TEST MAP_01(void) {
    ...
    int value = 1;
    each_istraight_list(&test, intincrement, &value);
...
TEST APPLY_01(void) {
    ...
    apply_istraight_list(&test, intqsort, NULL);

...
#define FRBT_NODE_COUNT 2
#define FRBT_LEFT  0
#define FRBT_RIGHT 1
#define FRED_COLOR true
#define FBLACK_COLOR false

/// Finite red black tree structure.
typedef struct finite_red_black_tree {
    compare_fn compare;
    char * elements;
    size_t * parent;
    size_t * node[FRBT_NODE_COUNT];
    bool * color;
...
/// @param argd Generic arguments to use in function pointer.
